...
import { ListRoutingProfileManualAssignmentQueuesRequest, ListRoutingProfileManualAssignmentQueuesResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListRoutingProfileManualAssignmentQueuesCommand_base: {
    new (input: ListRoutingProfileManualAssignmentQueuesCommandInput): import("@smithy/smithy-client").CommandImpl<ListRoutingProfileManualAssignmentQueuesCommandInput, ListRoutingProfileManualAssignmentQueuesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListRoutingProfileManualAssignmentQueuesCommandInput): import("@smithy/smithy-client").CommandImpl<ListRoutingProfileManualAssignmentQueuesCommandInput, ListRoutingProfileManualAssignmentQueuesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
