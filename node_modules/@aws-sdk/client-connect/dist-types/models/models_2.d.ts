import { AgentAvailabilityTimer, AgentStatusState, AutoEvaluationStatus, BooleanComparisonType, Channel, ChatEventType, ContactFlowModuleState, ContactFlowModuleStatus, ContactFlowState, ContactFlowStatus, ContactFlowType, ContactInitiationMethod, ContactRecordingType, DateComparisonType, DateTimeComparisonType, DecimalComparisonType, EmailHeaderType, EvaluationFormItemEnablementAction, EvaluationFormItemEnablementOperator, EvaluationFormQuestionType, EvaluationFormVersionStatus, EvaluationStatus, EvaluationType, FileStatusType, FileUseCaseType, HierarchyGroupMatchType, InboundMessageSourceType, InstanceAttributeType, InstanceStorageResourceType, IvrRecordingTrack, MeetingFeatureStatus, MonitorCapability, NumberComparisonType, OutboundMessageSourceType, ParticipantRole, ParticipantTimerAction, ParticipantTimerType, PhoneNumberCountryCode, PhoneNumberType, QueueStatus, RehydrationType, RulePublishStatus, SearchableQueueType, SearchContactsMatchType, SearchContactsTimeRangeConditionType, SearchContactsTimeRangeType, SortableFieldName, SortOrder, StringComparisonType, TargetListType, TaskTemplateStatus, TimerEligibleParticipantRoles, TrafficDistributionGroupStatus, TrafficType, UseCaseType, ViewStatus, ViewType, VocabularyLanguageCode, VocabularyState, VoiceRecordingTrack } from "./enums";
import { AgentConfig, AgentHierarchyGroups, AgentStatus, AliasConfiguration, AllowedCapabilities, Application, AttributeCondition, ControlPlaneAttributeFilter, CreatedByInfo, EvaluationFormItemEnablementExpression, EvaluationFormQuestionTypeProperties, HoursOfOperationConfig, HoursOfOperationOverrideConfig, InputPredefinedAttributeConfiguration, InstanceStorageConfig, MediaConcurrency, OutboundCallerConfig, OutboundEmailConfig, OutboundStrategy, PredefinedAttributeValues, QuickConnectConfig, Reference, RoutingProfileQueueConfig, RuleAction, StringCondition, TagCondition, TaskTemplateConstraints, TaskTemplateDefaults, TaskTemplateField, UserIdentityInfo, UserPhoneConfig, UserProficiency, View, ViewInputContent } from "./models_0";
import { ContactFlow, ContactFlowModule, EvaluationAnswerData, EvaluationNote, HierarchyGroup, HierarchyGroupSummary, HoursOfOperation, HoursOfOperationOverride, PredefinedAttribute, Prompt, Queue, QuickConnect, RoutingProfile, SignInConfig, TelephonyConfig } from "./models_1";
/**
